<%@ Page Title="" Language="C#" MasterPageFile="~/RollMaster.Master" AutoEventWireup="true" CodeBehind="Administrator.aspx.cs" Inherits="WebISMSManagmentSystem.Administrator" %>
...
<cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></cc1:ToolkitScriptManager>
    ...
    <center>
       <div id="new div" style="margin-left:-800px;margin-top:20px;; height: 31px; width: 297px;">
...
<StaticSelectedStyle CssClass="selectedtab" BackColor="#507CD1"></StaticSelectedStyle>
        ...
        <div style="margin-left:700px; margin-top:-35px; height: 28px; width: 416px;">
